/**
 * offers/models/Offer.ts
 * Canonical Offer shape. Source of truth for Console (via HTTP).
 * Mirrors shared/sales.ts — Value Equation + Grand Slam Offer structure.
...
export interface OfferInput {
  ...
  coreDeliverable: string;
  priceUsd: number;
  coreStatedValueUsd?: number;    // anchor value of the core offer itself
  bonuses?: BonusItem[];
